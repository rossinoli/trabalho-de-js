...
function multiplicarPorDois(array) {
        ...
        //EXERCICIO 9
const outroArray = [3, 5, 7, 9];
function encontrarComuns(array1, array2) {
        return array1.filter(elemento => array2.includes(elemento));
}
const elementosComuns = encontrarComuns(meuArray, outroArray);
document.getElementById('resultado9').textContent = elementosComuns.join(', ');
